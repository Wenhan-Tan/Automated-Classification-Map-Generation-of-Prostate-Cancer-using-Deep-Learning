...
If you want to skip the training part, skip the first 4 steps. If you skip, before you run these scripts, make sure you have downloaded trained weights and csv files generated by previous scripts from the link below. All 7 scripts have detailed header if you want to know more about how each script works.
